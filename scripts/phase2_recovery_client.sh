...
OUT_BASE="${OUT_BASE:-logs/RecoveryGen/Phase2_validation/client_logs/${RUN_TAG}}"
mkdir -p "${OUT_BASE}"
...
SERVER_SIG_FILE="${SERVER_SIG_FILE:-logs/RecoveryGen/Phase2_validation/current_server_sig.json}"
...
if [[ "${OUT_BASE}" == "logs/RecoveryGen/Phase2_validation/client_logs/${RUN_TAG}" ]]; then
...
PY
  ...
  OUT_BASE="logs/RecoveryGen/Phase2_validation/client_logs/${RUN_TAG}_${SERVER_SIG_SHORT}_${GATE_SIG}"
  mkdir -p "${OUT_BASE}"
fi
